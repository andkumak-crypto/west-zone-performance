                ...
                {(() => {
                  ...
                  return (
                    <div className="space-y-3">
                      <h3 className="text-xs font-bold tracking-wider uppercase text-gray-400">Region-wise Session Split</h3>
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        {regionsData.map((row) => {
                          ...
                          return (
                            <div 
                              key={row.name}
                              className={`bg-gradient-to-b from-[#0e172a] to-[#070d1e] border ${cardColorBorder} rounded-2xl p-5 shadow-lg relative overflow-hidden flex flex-col justify-between min-h-[140px] transition-all duration-200 hover:-translate-y-0.5`}
                            >
                              <div className="space-y-1">
                                <span className="text-xs font-bold text-gray-400 tracking-wide block">{row.name}</span>
                                <span className="text-3xl font-black font-mono text-white leading-none block pt-1">
                                  {row.total.toLocaleString()}
                                </span>
                                <span className="text-3xs text-gray-500 block font-semibold mt-0.5">
                                  {totalPct}% of total
                                </span>
                              </div>

                              <div className="flex flex-wrap gap-2 pt-4">
                                <span className="inline-flex items-center px-2.5 py-1 rounded-lg text-3xs font-bold bg-emerald-500/10 text-emerald-400 border border-emerald-500/20">
                                  Physical {physPct}%
                                </span>
                                <span className="inline-flex items-center px-2.5 py-1 rounded-lg text-3xs font-bold bg-sky-500/10 text-sky-400 border border-sky-500/20">
                                  Virtual {virtPct}%
                                </span>
                                {oosPct > 0 && (
                                  <span className="inline-flex items-center px-2.5 py-1 rounded-lg text-3xs font-bold bg-purple-500/10 text-purple-400 border border-purple-500/20">
                                    OOS {oosPct}%
                                  </span>
                                )}
                              </div>
                            ...
                            return (
                              ...
                              >
                                ...
                                <td className="py-3 px-4">
                                  <span className="inline-flex items-center px-2 py-0.5 rounded bg-[var(--theme-accent-10)] border border-[var(--theme-accent-20)] text-[var(--theme-accent)] text-3xs font-extrabold uppercase font-mono">
                                    {row.tl || "No TL"}
                                  </span>
                                </td>
                                ...
                                <td className="py-3 px-4 font-black text-[var(--theme-accent)] font-mono">{row.totalTraining}</td>
